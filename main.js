...
const apiKey = '05ff43e9d7d6cc2e55c0c71f0ad17496';
...
function getCurrentDate() {
    ...
    date.innerHTML = `${day.toString()} ${months[month].toString()} ${year.toString()} г.`;
}
            ...
            navigator.geolocation.getCurrentPosition(async (position) => {
                ...
                async function getWeather() {
                    ...
                    function getCurrentImg() {
                        ...
                        let gradient = `linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3))`;
